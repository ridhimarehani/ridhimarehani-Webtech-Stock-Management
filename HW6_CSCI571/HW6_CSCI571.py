...
def get_stock_search():
    ...
    # print('d1>',data, data.status_code)
    return data.json()
...
def get_stock_summary():
    ...
    # print('d2>',data_st,data_stock.status_code,data_recommend.status_code)
...
def get_stock_charts():
    ...
    # print('d3>',data_charts,data_charts.status_code)
...
def get_stock_news():
    ...
    # print('d4> ',data_news.json(),data_news.status_code)
    if data_news.json() != []:
        ...
        while(counter1 < 5):
            ...
            (data_news_json[counter2]['datetime'] != '' or data_news_json[counter2]['datetime'] != None)):
                ...
                counter1 += 1
            counter2 += 1
    # print('d4> ',data_news_res,data_news.status_code)
